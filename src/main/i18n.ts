...
const STRINGS: Record<Lang, Dict> = {
  en: {
    ...
    "notif.cliRestartedBody": "{provider}: {count} reopened in a new terminal; {closed} old terminals closed.",
    "notif.cliRestartedManualBody": "{provider}: {count} reopened in a new terminal; {closed} old terminals closed; {manual} need manual resume. Resume command copied.",
  ...
  ko: {
    ...
    "notif.cliRestartedBody": "{provider}: 새 터미널에서 재개 {count}개, 기존 터미널 종료 {closed}개.",
    "notif.cliRestartedManualBody": "{provider}: 새 터미널에서 재개 {count}개, 기존 터미널 종료 {closed}개, 수동 재개 필요 {manual}개. 명령을 클립보드에 복사했습니다.",
  ...
  ja: {
    ...
    "notif.cliRestartedBody": "{provider}: 新しいターミナルで {count} 個を再開し、既存ターミナル {closed} 個を閉じました。",
    "notif.cliRestartedManualBody": "{provider}: 新しいターミナルで {count} 個を再開し、既存ターミナル {closed} 個を閉じました。{manual} 個は手動再開が必要です。再開コマンドをコピーしました。",
  ...
  zh: {
    ...
    "notif.cliRestartedBody": "{provider}：已在新终端恢复 {count} 个，已关闭原终端 {closed} 个。",
    "notif.cliRestartedManualBody": "{provider}：已在新终端恢复 {count} 个，已关闭原终端 {closed} 个；{manual} 个需要手动恢复。恢复命令已复制。",
