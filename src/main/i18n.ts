...
const STRINGS: Record<Lang, Dict> = {
  en: {
    ...
    "notif.cliRestartedBody": "{provider} sessions {count} restarted — resumed with the new account",
    "notif.cliRestartedManualBody": "{provider} sessions {count} restarted; {manual} need manual resume. Resume command copied.",
  ...
  ko: {
    ...
    "notif.cliRestartedBody": "{provider} 세션 {count}개 재시작됨 — 새 계정으로 재개",
    "notif.cliRestartedManualBody": "{provider} 세션 {count}개 재시작됨 — 수동 재개 필요 {manual}개. 명령을 클립보드에 복사했습니다.",
  ...
  ja: {
    ...
    "notif.cliRestartedBody": "{provider} セッション {count} 個を再起動しました — 新しいアカウントで再開",
    "notif.cliRestartedManualBody": "{provider} セッション {count} 個を再起動しました。{manual} 個は手動再開が必要です。再開コマンドをコピーしました。",
  ...
  zh: {
    ...
    "notif.cliRestartedBody": "{provider} 会话已重启 {count} 个 — 已用新账号恢复",
    "notif.cliRestartedManualBody": "{provider} 会话已重启 {count} 个；{manual} 个需要手动恢复。恢复命令已复制。",
